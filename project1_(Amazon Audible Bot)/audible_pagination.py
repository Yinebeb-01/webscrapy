...
# The first website has 5 pages while the second has 60.
...
path = 'F:/Desktop_Apps/chromedriver_win32/chromedriver' # write your path where the chromedriver,exe located.
...
df_books.to_csv('ListOfBooks_pagination.csv', index=False)
